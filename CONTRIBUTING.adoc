...
toolbox create universal-project-manager-dev toolbox enter
universal-project-manager-dev # Install dependencies manually
...
universal-project-manager/ ├── src/ # Source code (Perimeter 1-2) ├──
